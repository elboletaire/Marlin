...
#define STRING_CONFIG_H_AUTHOR "(elboletaire, Ender-3 Pro SKRMini & BlTouch)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  20.43
    #define DEFAULT_Ki   1.47
    #define DEFAULT_Kd 71.10
  #endif
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400.85, 138.30 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -6, -1.95 }
